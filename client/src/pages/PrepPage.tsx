...
export default function PrepPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4">
      <div><h1 className="text-2xl font-bold">面试准备</h1><p className="text-gray-500 text-sm mt-1">JD分析 + AI模拟面试，一站式备战</p></div>

      <Tabs value={tab} onValueChange={v => { setTab(v); if (v === 'mock') setMockStep('setup'); }}>
        <TabsList className="w-full max-w-md">
          <TabsTrigger value="prep" className="flex-1"><FileSearch className="w-4 h-4 mr-1" />JD分析</TabsTrigger>
